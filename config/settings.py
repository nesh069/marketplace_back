"""
Django settings for marketplace_back project.
"""
...
CORS_ALLOWED_ORIGINS = os.environ.get(
    ...
    'http://localhost:5173,http://127.0.0.1:5173,https://marketplace-front-mu.vercel.app'
).split(',')

CORS_ALLOWED_ORIGIN_REGEXES = [
    r'https://marketplace-front-mu-.*\.vercel\.app',
]
